    ...
    <footer className="bg-slate-800">
      <Container>
        <div className="py-16 flex flex-col sm:flex-row items-center">
          <p className='text-slate-100 mb-0 grow pb-6 sm:pt-0'>Designed and built by Artem Avetisyan.<br/> <Link target='_blank' href='https://github.com/artemave/artem.rocks'>View source</Link></p>
